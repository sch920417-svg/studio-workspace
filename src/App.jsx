...
// 실제 환경에서는 이 부분 대신 Node.js 서버의 API 엔드포인트를 호출하여 처리합니다.
...
export default function App() {
  ...
  const saveThread = async () => {
    ...
    const threadData = { ...threadDraft, updatedAt: serverTimestamp() };
  ...
  const createNewBlog = () => {
    ...
    const newBlog = { id: newBlogId, title: '제목 없는 문서', link: '', date: newBlogDate, tags: [], blocks: [] };
      ...
      <main className="flex-1 overflow-y-auto relative bg-neutral-950">
        <div className={`mx-auto ${currentView === 'blog' || currentView === 'thread' ? 'max-w-7xl' : 'max-w-6xl'} p-4 md:p-8 h-full`}>
          ...
          {/* --------------------------------------
              ...
              -------------------------------------- */}
          {currentView === 'thread' && (
            <div className="h-full flex flex-col md:flex-row gap-6 animate-in fade-in duration-500 pb-8">
                ...
                <div className="mb-2">
                  ...
                  <div className="grid grid-cols-7 gap-0.5">
                    ...
                    {Array.from({ length: getDaysInMonth(currentCalendarDate.getFullYear(), currentCalendarDate.getMonth()) }).map((_, i) => {
                      ...
                      const hasThread = threads.some(t => t.date === dateStr);
              ...
              <div className="flex-1 bg-neutral-900 border border-neutral-800 rounded-2xl flex flex-col overflow-hidden shadow-2xl relative min-w-0">
                {activeThreadId === 'new' || isEditingThread ? (
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="p-5 md:p-6 space-y-4 flex-1 overflow-y-auto custom-scrollbar bg-neutral-900 flex flex-col">
                    ...
                    <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
                       ...
                       <div className="flex items-center justify-between mb-6 border-b border-neutral-800 pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-bold text-white">beanute_studio</div>
                ...
                <div className="mb-2">
                  ...
                  <div className="grid grid-cols-7 gap-0.5">
                    ...
                    {Array.from({ length: getDaysInMonth(blogCalendarDate.getFullYear(), blogCalendarDate.getMonth()) }).map((_, i) => {
                      ...
                      const hasBlog = blogs.some(b => b.date === dateStr);
                      const isToday = dateStr === toISODate(new Date());
